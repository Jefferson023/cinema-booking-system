...
import compgc01.model.SendEmail;
...
public class FeedbackController implements Initializable {
    ...
    public void setStars() {
        ...
        Main.setStars(starNumber);
    }

    public void setExperience() {

        Main.setExperience(experience);
    }

    public void setFilm() {

        try {
            Main.setFeedbackFilmTitle(filmDropDownList.getValue().toString());
        } catch (NullPointerException e) {
            e.getMessage();
        }
    }
    ...
    public void setComment() {
        ...
        Main.setComment(feedbackComment.getText().toString());
    }
}